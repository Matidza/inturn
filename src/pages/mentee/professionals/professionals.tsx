...
//    CONSTANTS
// ───────────────────────────────────────────────────────────── */
// const API_URL       = "http://localhost:1000/api/v1/mentee/professionals";
// const MAX_PRICE     = 300;
...
//         {/* About
//         <Typography sx={{
//           fontSize: 13.5, color: INK2, lineHeight: 1.7, flex: 1,
//           display: "-webkit-box", WebkitLineClamp: 2,
//           WebkitBoxOrient: "vertical", overflow: "hidden", mb: 1.25,
//         }}>
//           {pro.aboutUser ?? `Mock interview prep for ${pro.interviewFocusArea?.[0] ?? "your target role"}`}
//         </Typography> */}
...
//         {/* Divider
//         <Box sx={{ height: 1, background: BORDER, mb: 1.25 }}/> */}
...
//         // const { data } = await axiosInstance.get(API_URL, { timeout: 10000 });
//         const { data } = await axios.get(API_URL, { timeout: 10000, withCredentials: true });
//         if (!cancelled) {
