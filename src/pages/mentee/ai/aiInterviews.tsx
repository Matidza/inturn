...
//   ClipboardCheck, Image, Presentation, AlertTriangle,
//   X, Check, ArrowRight,
...
const authFetch = async (path: string, opts: RequestInit = {}) => {
  ...
  // .catch(() => ({})) guards against an empty/non-JSON response body
  // (e.g. a server-side error that returns no content) throwing a raw,
  // unreadable "Unexpected end of JSON input" instead of a clean message.
